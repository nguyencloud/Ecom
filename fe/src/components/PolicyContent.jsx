      ...
      <div className="ThePolicy">
        ...
        <div className="policy-content">
          ...
          <div className="text-strong">
            (THE FIFTH LABLE chỉ hỗ trợ bảo hành sản phẩm hư hỏng trong điều kiện sử
          ...
          <ul>
            <li>
              1 đổi 1 tại nhà, nếu hết hàng đổi khác THE FIFTH LABLE trả lại tiền
              chênh lệch nếu có.
            </li>
            <li>Hoặc sản phẩm thì nhận lại tiền 80% giá trị máy.</li>
          ...
          <ul>
            <li>
              THE FIFTH LABLE hỗ trợ bảo hành theo tiêu chuẩn hãng hoặc chuyển hãng
              bảo hành khi cần.
            </li>
          </ul>
          ...
          <ul>
            <li>
              Không đổi trả, THE FIFTH LABLE hỗ trợ bảo hành theo tiêu chuẩn hãng
              hoặc chuyển hãng bảo hành khi cần.
            </li>
            <li>Sản phẩm không lỗi Không đổi trả.</li>
            <li>
              Sản phẩm lỗi do người dùng Không bảo hành đổi trả. THE FIFTH LABLE hỗ
  ...
  const Shipping = () => {
    return (
      <div className="ThePolicy">
        ...
        <div className="policy-content">
          <div className="text-strong">
            THE FIFTH LABLE có dịch vụ vận chuyển uy tín, đảm bảo các mặt hàng đến
          ...
          <p>
            Hãy trực tiếp đến địa chỉ các showroom của THE FIFTH LABLE để lựa chọn
          ...
          <p>
            Nếu bạn không muốn trực tiếp đến cửa hàng. THE FIFTH LABLE sẵn sàng giao
          ...
          <p>
            ...
            (thanh toán khi nhận hàng), các bạn vui lòng liên hệ với THE FIFTH LABLE
            ...
            xác nhận, THE FIFTH LABLE có 2 hình thức mua hàng và thanh toán như sau:
          </p>
          <ul>
            <li>
      ...
      <div className="ThePolicy">
        ...
        <div className="policy-content">
          ...
          <p>
            ...
            Delivery) – Các bạn sẽ thanh toán trực tiếp cho bên chuyển phát sau
            khi đã nhận được hàng. Với hình thức này, để đảm bảo đơn hàng được
            xác nhận, THE FIFTH LABLE có 2 hình thức mua hàng và thanh toán như
            sau:THE FIFTH LABLE chấp nhận hình thức thanh toán chuyển khoản ngân
      ...
      <div className="ThePolicy">
        ...
        <div className="policy-content">
          <div className="text-strong">
            ...
            hết, quý khách có thể an tâm mua sắm tại THE FIFTH LABLE.
          </div>
          ...
          <ul style={{ listStyleType: "decimal" }}>
            ...
            <li style={{ fontWeight: "bold" }}>
              ...
              <p style={{ display: "inline-block", fontWeight: "400" }}>
                THE FIFTH LABLE có quyền từ chối và không giải quyết các khiếu nại
          ...
          <p style={{ display: "inline-block", fontWeight: "400" }}>
            Mọi CBNV, đơn vị, Showroom thuộc THE FIFTH LABLE đều có trách nhiệm tiếp
          ...
          <p style={{ display: "inline-block", fontWeight: "400" }}>
            Đơn vị, cá nhân thuộc thẩm quyền theo quy định của THE FIFTH LABLE tiến
          ...
          <p style={{ display: "inline-block", fontWeight: "400" }}>
            Khi có kết quả kiểm tra, xác minh THE FIFTH LABLE sẽ trả lời khách hàng
