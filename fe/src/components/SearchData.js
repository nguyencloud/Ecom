const product = [
        {
            _id:'1',
            image: require('../img/Xiaomi/1.jpg'),
            sale: '-20%',
            name: 'Robot hút bụi Xiaomi Vacuum Mop 2 Pro',
            label: 'Xiaomi',
            priceOff: '9.990.000 đ',
            priceOn: '6.690.000 đ',
            title: 'Robot hút bụi Xiaomi Vacuum Mop 2 Pro - Phụ kiện dọn dẹp không gian nhà ở',
            describe: [
        ...
        {
            _id:'2',
            image: require('../img/Xiaomi/2.jpg'),
            sale: '-20%',
            name: 'Robot hút bụi Xiaomi Vacuum Mop 2 Lite',
            label: 'Xiaomi',
            priceOff: '5.990.000 đ',
            priceOn: '3.990.000 đ',
            title: 'Robot hút bụi Xiaomi Vacuum Mop 2 Lite - Làm sạch toàn diện, tiết kiệm thời gian',
            describe: [
                'Thiết kế nhỏ gọn, tính cơ động cao - Thiết kế linh hoạt dễ dàng di chuyển đến khắp ngóc ngách',
                'Lực hút mạnh mẽ - Lực hút 2.200 Pa, hoạt động ổn định, hiệu quả',
                'Đa dạng chức năng sử dụng - Kết hợp vừa hút bụi, vừa lau giúp không gian sạch toàn diện',
                'Hỗ trợ điều khiển từ xa - Điều khiển qua app Mi Home mọi lúc   '
            ]
        },

        {
            ...
            priceOn: '5.990.000 đ',
            title: 'Robot hút bụi Xiaomi Vacuum Mop 2 - Làm sạnh hiệu quả không gian nhà',
            describe: [
...

        {
            ...
            priceOff: '9.990.000 đ',
            priceOn: '6.990.000 đ',
            title: 'Robot hút bụi Xiaomi Vacuum Mop Pro - công suất mạnh cùng 3 chế độ làm việc',
            describe: [
        ...
        {
            _id:'5',
            image: require('../img/Xiaomi/5.jpg'),
            sale: '-20%',
            name: 'Robot hút bụi Xiaomi Vacuum Mop SKV4093GL',
            label: 'Xiaomi',
            priceOff: '7.490.000 đ',
            priceOn: '5.990.000 đ',
            title: 'Robot hút bụi Xiaomi Vacuum Mop SKV4093GL - Thiết kế tiện lợi, lực hút mạnh mẽ',
            describe: [
...

        {
            ...
            title: 'Robot hút bụi Ecovacs Deebot T10 Omni – Công nghệ AI với khả năng làm sạch ưu việt',
            Describe: [
...

        {
            ...
            title: 'Tuyệt tác công nghệ – Siêu phẩm hàng đầu cho một ngôi nhà sạch thông minh',
            describe: [
        ...
        
        {
            ...
            title:'Tuyệt tác công nghệ, Xóa bỏ mọi giới hạn – Trọn vẹn trải nghiệm lau dọn thông minh.',
            describe: [               
...

        {
            ...
            priceOff: '7.490.000 đ',
            priceOn: '5.490.000 đ',
            title: 'Liectroux F5Eco - Siêu phẩm mới tháng 7 năm 2022 của thương hiệu Liectroux',
            describe: [
                'Chức năng: Hút bụi, vừa lau vừa hút đồng thời',
                'Lực hút: 3000Pa - hút sạch mọi bụi bẩn',
...

        {
            ...
            describe: [
                'Tích hợp 2 tính năng hút bụi, lau nhà.' ,'Lực hút siêu khỏe 4000pa  làm sạch hiệu quả mọi loại sàn.',
